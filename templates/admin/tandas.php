...
<section class="col-md-10">
    ...
    if (isset($_GET['action'])) {
        ...
        if ($action == "update") {
            ...
            $id_session_user = $sesionDAO->getIdSessionUsers($id);


            if ($id_session_user != null)
                header("Location: " . "../simulate.php?session=" . $id . "&session_user=" . $id_session_user);
            else
                header("Location: " . $_SERVER['PHP_SELF'] . "?option=sesiones&id_session=" . $id);
        ...
        if ($action == "create" || $action == "update") {
            ...
            <form action="#" method="POST">
                Nombre:<input name="nombre" type="text"
                              value="<?php echo $sesion != null ? $sesion->getName() : ''; ?>"><br>
                Fecha:<input name="fecha" type="datetime-local"
                             value="<?php echo $sesion != null ? $sesion->getDate() : ''; ?>"><br>
                Tipo:
                <select name="tipo">
                    <?php
